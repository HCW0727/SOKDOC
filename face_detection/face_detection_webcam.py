...
base_options = python.BaseOptions(model_asset_path='/Users/huhchaewon/Python_Projects/HNW/model/face_detection.tflite')
...
while True:
  ...
  image_copy = np.copy(rgb_image.numpy_view())
